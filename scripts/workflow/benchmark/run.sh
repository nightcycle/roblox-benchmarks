...
SCRIPT_CONTENTS="_G.FILTER_PATH='${BENCHMARK_PATH}';_G.DATA_DIR='${DATA_SUBMODULE_PATH}/${DATA_DIR_PATH}';_G.IS_DEBUG=false;_G.RUNNER_INDEX=${RUN_INDEX};${SCRIPT_CONTENTS}"
